...
#_______________________Loop Iteration______________________________________________
counter = 0
while True:
...
##    print C1, C3
    ...
    #_______________________Get new r vectors_______________________________
    rvector1 = (rho1*unitRho1)-Rvector1
    rvector2 = (rho2*unitRho2)-Rvector2
    rvector3 = (rho3*unitRho3)-Rvector3
    r2old = r2
...
##    print rvector2
    ...
    #_______________________Get new r dot vector 2__________________________
    d1 = -f3/(f1*g3-f3*g1)
    d3 = f1/(f1*g3 - f3*g1)
    rDotVector2 = (d1*rvector1)+(d3*rvector3)
    a2, e2, i2, O2, w2, M2, E2 = babyOD(rvector2, rDotVector2)
