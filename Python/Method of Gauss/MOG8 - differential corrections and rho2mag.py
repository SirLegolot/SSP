...
if len(possibleRoots)>1:
    ...
    choice = input("Which root do you want to choose: ")
    r2 = possibleRoots[choice-1]
else:
    r2 = possibleRoots[0]
##print "initial r2:",r2
...
if dc == 1:
    ...
    timemid = time[choice] #2457956.75 #time for epoch july 22, 2017 6 UT
...
##    print calcDec1, calcDec2, calcDec3, calcDec4 
    ...
    print "diffRA: ", diffRA1, diffRA2, diffRA3, diffRA4
    ...
    for i in range(4):
        ...
        nrvector2[0] = rvector2[0]*deltavpos
    ...
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrvector2[0] = rvector2[0]*deltavneg
        a2, e2, i2, O2, w2, M2, E2 = babyOD(nrvector2, rDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddxn.append(newRA1)
        ddxn.append(newDec1)
    ddxn = np.array(ddxn)
    ddx = (ddxp-ddxn)/(2*deltav*rvector2[0])

    ddyp = []
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrvector2[1] = rvector2[1]*deltavpos
        a2, e2, i2, O2, w2, M2, E2 = babyOD(nrvector2, rDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddyp.append(newRA1)
        ddyp.append(newDec1)
    ...
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrvector2[1] = rvector2[1]*deltavneg
        a2, e2, i2, O2, w2, M2, E2 = babyOD(nrvector2, rDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddyn.append(newRA1)
        ddyn.append(newDec1)
    ddyn = np.array(ddyn)
    ddy = (ddyp-ddyn)/(2*deltav*rvector2[1])

    ddzp = []
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrvector2[2] = rvector2[2]*deltavpos
        a2, e2, i2, O2, w2, M2, E2 = babyOD(nrvector2, rDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddzp.append(newRA1)
        ddzp.append(newDec1)
    ...
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrvector2[2] = rvector2[2]*deltavneg
        a2, e2, i2, O2, w2, M2, E2 = babyOD(nrvector2, rDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddzn.append(newRA1)
        ddzn.append(newDec1)
    ddzn = np.array(ddzn)
    ddz = (ddzp-ddzn)/(2*deltav*rvector2[2])

    ddxdotp = []
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrDotVector2 = np.copy(rDotVector2)
        nrDotVector2[0] = nrDotVector2[0]*deltavpos
    ...
    for i in range(4):
        nrDotVector2 = np.copy(rDotVector2)
        nrDotVector2[0] = nrDotVector2[0]*deltavneg
        a2, e2, i2, O2, w2, M2, E2 = babyOD(rvector2, nrDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddxdotn.append(newRA1)
        ddxdotn.append(newDec1)
    ddxdotn = np.array(ddxdotn)
    ddxdot = (ddxdotp-ddxdotn)/(2*deltav*rDotVector2[0])

    ddydotp = []
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrDotVector2 = np.copy(rDotVector2)
        nrDotVector2[1] = nrDotVector2[1]*deltavpos
        a2, e2, i2, O2, w2, M2, E2 = babyOD(rvector2, nrDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
    ...
    for i in range(4):
        nrDotVector2 = np.copy(rDotVector2)
        nrDotVector2[1] = nrDotVector2[1]*deltavneg
        a2, e2, i2, O2, w2, M2, E2 = babyOD(rvector2, nrDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddydotn.append(newRA1)
        ddydotn.append(newDec1)
    ddydotn = np.array(ddydotn)
    ddydot = (ddydotp-ddydotn)/(2*deltav*rDotVector2[1])

    ddzdotp = []
    for i in range(4):
        nrvector2 = np.copy(rvector2)
        nrDotVector2 = np.copy(rDotVector2)
        nrDotVector2[2] = nrDotVector2[2]*deltavpos
        a2, e2, i2, O2, w2, M2, E2 = babyOD(rvector2, nrDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
    ...
    for i in range(4):
        nrDotVector2 = np.copy(rDotVector2)
        nrDotVector2[2] = nrDotVector2[2]*deltavneg
        a2, e2, i2, O2, w2, M2, E2 = babyOD(rvector2, nrDotVector2)
        newRA1, newDec1 = ephem(a2, e2, i2, O2, w2, M2, time[i], timemid, nRvector[i])
        ddzdotn.append(newRA1)
        ddzdotn.append(newDec1)
    ddzdotn = np.array(ddzdotn)
    ddzdot = (ddzdotp-ddzdotn)/(2*deltav*rDotVector2[2])
...
##                         [m1[5,0]*dR[0] + m1[5,2]*dR[1] + m1[5,4]*dR[2] + m1[5,6]*dR[3] + m1[5,1]*dD[0] + m1[5,3]*dD[1] + m1[5,5]*dD[2] + m1[5,7]*dD[3]]])
    ...
    solnmatrix = np.dot(Jacobmatrix, vermatrix)
##    print solnmatrix
